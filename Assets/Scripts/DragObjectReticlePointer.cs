...
public class DragObjectReticlePointer : GvrBasePointer {
	...
	public override void OnPointerClickDown() {
		ExecuteEvents.Execute (pointedAt, null, (DragObjectHandler handler, BaseEventData data) => handler.HandlePointerClickDown ());
	}

	/// Called when a trigger event is finished. This is practically when
	/// the user releases the trigger.
	public override void OnPointerClickUp() {
		ExecuteEvents.Execute (pointedAt, null, (DragObjectHandler handler, BaseEventData data) => handler.HandlePointerClickUp ());
	}
